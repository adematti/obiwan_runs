...
output_dir = os.path.join(os.getenv('CSCRATCH'),'Obiwan','dr9','ebv100like','north')
...
randoms_fn = os.path.join(os.getenv('CSCRATCH'),'Obiwan','dr9','ebv100','randoms','randoms.fits')
